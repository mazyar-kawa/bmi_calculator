              ...
              childCard: Row(
                children: [
                  ...
                  Expanded(
                    ...
                    onPressed: () {
                      setState(() {
                        changeGender(Gender.transgender);
                      });
                    },
                    fontWeight: selectGender == Gender.transgender
                        ? FontWeight.bold
                        : FontWeight.normal,
                    blur: selectGender == Gender.transgender ? 3.5 : 0,
                    colour: selectGender == Gender.transgender
                        ? Colors.black
                        : Colors.grey,
                  )),
                ],
